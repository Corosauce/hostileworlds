...
public class CommonProxy implements IGuiHandler
{
    ...
    public void init(HostileWorlds pMod)
    {
        ...
        EntityRegistry.registerModEntity(OrcBoss.class, "OrcBoss", entityId++, pMod, 128, 1, true);
        EntityRegistry.registerModEntity(OrcSeeker.class, "OrcSeeker", entityId++, pMod, 128, 1, true);
        
        EntityRegistry.registerModEntity(EntityArrow.class, "HWEntityArrow", entityId++, pMod, 128, 1, true);
        EntityRegistry.registerModEntity(EntityFireBall.class, "HWEntityFireBall", entityId++, pMod, 128, 1, true);
        ...
        if (ModConfigFields.spawnHungryZombie) EntityRegistry.addSpawn(ZombieHungry.class, 5, 1, 1, EnumCreatureType.monster, biomes);
        if (ModConfigFields.spawnClawerZombie) EntityRegistry.addSpawn(ZombieClawer.class, 1, 1, 1, EnumCreatureType.monster, biomes);
    }
