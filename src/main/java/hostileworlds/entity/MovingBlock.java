...
public class MovingBlock extends Entity implements IEntityAdditionalSpawnData
{
    ...
    public void onUpdate()
    {
        ...
        if (!worldObj.isRemote) {
	        ...
	        if (blockifyDelay != -1 && age > blockifyDelay) {
		    	...
		    	Block id = worldObj.getBlock(aheadX, aheadY, aheadZ);
		    	
		    	if (!CoroUtilBlock.isAir(id) && worldObj.getTileEntity(aheadX, aheadY, aheadZ) == null && id != HostileWorlds.blockBloodyCobblestone && id.getMaterial() != Material.water && id.getMaterial() != Material.circuits && id.getMaterial() != Material.snow && id.getMaterial() != Material.plants && id.getMaterial().isSolid()) {
    ...
    {
    	ByteBufUtils.writeUTF8String(data, Block.blockRegistry.getNameForObject(blockID));
    ...
    {
    	blockID = (Block)Block.blockRegistry.getObject(ByteBufUtils.readUTF8String(data));
	...
	protected void readEntityFromNBT(NBTTagCompound data) {
		this.blockID = (Block)Block.blockRegistry.getObject(data.getString("blockID"));
	...
	protected void writeEntityToNBT(NBTTagCompound data) {
		data.setString("blockID", Block.blockRegistry.getNameForObject(blockID));
