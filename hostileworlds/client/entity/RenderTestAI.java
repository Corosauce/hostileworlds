...
public class RenderTestAI extends RenderLiving {
    
    protected ModelTest modelVMonkey;

    public RenderTestAI(ModelTest modelbase, float f) {
        super(modelbase, f);
        modelVMonkey = modelbase;
    }

    public void func_177_a(EntityTestAI entity, double d, double d1, double d2,
            float f, float f1) {
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2,
            float f, float f1) {
        super.doRenderLiving((EntityTestAI) entityliving, d, d1, d2, f, f1);
    }

    @Override
    public void doRender(Entity entity, double d, double d1, double d2,
            float f, float f1) {
        doRenderLiving((EntityTestAI) entity, d, d1, d2, f, f1);
    }
