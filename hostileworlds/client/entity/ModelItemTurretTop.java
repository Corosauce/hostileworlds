...
public class ModelItemTurretTop extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float entScale = -0.4F;//entity.width + 1F;
        
        GL11.glRotatef(180F, 1, 0, 0);
        //GL11.glTranslatef(0F, -entScale, -entScale+0F);
        //GL11.glTranslatef(0F, 2.2F, 0F);
        
        //GL11.glScalef(entity.height, entity.width, entity.height);
        
        float adj = entScale;
        
        GL11.glScalef(adj, adj - 0.8F, adj);
    ...
    public void setLivingAnimations(EntityLiving entityliving, float f, float f1, float f2) {
        ...
        if (entityliving instanceof EntityTestAI) {
        	EntityTestAI entityvmonkey = (EntityTestAI) entityliving;
