...
public class BlockRaidingLadder extends BlockContainer {

	public boolean isBase = false;
	
	public BlockRaidingLadder(int par1, int par2, boolean parBase) {
    ...
    {
		if (isBase) {
			return null;//new TileEntityRaidingLadderBase();
		} else return null;
    }
