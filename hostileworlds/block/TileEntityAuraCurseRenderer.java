...
public class TileEntityAuraCurseRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
    	...
    	float scale = 0.15F;
    	int dim = var1.worldObj.provider.dimensionId;
    	...
    	for (int i = 0; i < invSize; i++) {
    		...
    		renderLivingLabel("Wave: " + inv.waveCount + "/3, " + "Leaders: " + inv.lastLeaderCount + ", Last spawned: " + inv.currentWaveSpawnedInvaders, var2, var4+sizeOffset-0.2F+offset, var6, 1);
